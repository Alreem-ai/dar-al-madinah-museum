        ...
        {(() => {
          ...
          const content = {
            ar: {
              ...
              body: 'يهدف هذا المشروع إلى تطوير الموقع الإلكتروني الخاص بـ متحف دار المدينة، من خلال تحسين تجربة المستخدم وتعزيز عرض المحتوى الثقافي والتاريخي. ركّزنا في هذا التطوير على تحديث طريقة عرض المقتنيات لتكون أكثر تنظيمًا ووضوحًا، مع إضافة صور عالية الجودة تعكس تفاصيل المعروضات بشكل أدق. كما تم إثراء المحتوى بشرح مبسّط وجذاب يدعم فهم الزائر، إلى جانب إدراج خاصية الصوت لعرض المعلومات بشكل تفاعلي، مما يسهم في تحسين الوصول للمحتوى لمختلف الفئات. كذلك حرصنا على توفير الموقع بعدة لغات لتوسيع نطاق الاستفادة والوصول إلى جمهور عالمي',
            },
            en: {
